...
> - `r shiny::icon("github")` [https://github.com/derekmichaelwright/AGILE_LDP_Nepal](https://github.com/derekmichaelwright/AGILE_LDP_Nepal){target="_blank"}
...
> - `r shiny::icon("save")` [data_pca_results.csv](data_pca_results.csv)
> - `r shiny::icon("save")` [model_t+p_coefs.csv](model_t+p_coefs.csv)
...
```{r echo = F}
DT::datatable(read.csv("data_env.csv"))
```
...
> - `r shiny::icon("globe")` [https://derekmichaelwright.github.io/AGILE_LDP_Nepal/Figure_04.html](https://derekmichaelwright.github.io/AGILE_LDP_Nepal/Figure_04.html){target="_blank"}
...
> - `r shiny::icon("save")` [model_nepal.csv](model_nepal.csv)
